    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prueba', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='preguntas', to='backend.prueba')),
            ],
        ),
        migrations.CreateModel(
            name='Persona',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grupo', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='backend.grupo')),
                ('prueba', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='backend.prueba')),
            ],
        ),
        migrations.CreateModel(
            name='Enunciado',
